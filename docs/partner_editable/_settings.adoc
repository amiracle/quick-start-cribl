...
:partner-product-short-name: Cribl LogStream
...
:quickstart-contributors: Kamilo "Kam" Amir, AWS Quick Start team
...
:marketplace_listing_url: https://aws.amazon.com/marketplace/pp/prodview-3wsytwvqb65gg?sr=0-1&ref_=beagle&applicationId=AWSMPContessa
