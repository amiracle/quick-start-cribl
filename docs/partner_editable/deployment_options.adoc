...
* *Deploy {partner-product-short-name} into an existing VPC with VPC Flow Logging Enabled*. This option provisions {partner-product-short-name} in your existing AWS infrastructure.
